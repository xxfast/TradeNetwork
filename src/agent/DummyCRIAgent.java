 ...
 */
public class DummyCRIAgent extends Agent {
	private int nResponders;

	protected void setup() { 
		String service = "RetailerAgent";
	...
	private void setResponderAgents (ACLMessage msg, String service) {
		
		DFAgentDescription[] serviceAgents = getService(service);
		
    	for (DFAgentDescription serviceAgent : serviceAgents) {
    		System.out.println("Adding new responder: " + serviceAgent.getName().getName());
